  ...
  return (
    <section className="max-w-4xl mt-10 text-center mx-auto px-6 py-12">
      ...
      <p className="text-gray-700">
        We do not sell your personal information to third parties. For questions, contact us at <a href="mailto:ebenmulugmail.com" className="text-purple-600 underline">support@metestore.com</a>.
      </p>
    </section>
  );
};
