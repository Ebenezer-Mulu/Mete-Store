    ...
    <div className=" md:flex-row justify-between items-start md:items-center bg-white p-6 rounded-md shadow max-w-6xl mx-auto my-8 space-y-6 md:space-y-0">
      <div className="max-w-2xl">
        ...
        <p className="text-gray-400 text-lg mb-2">
          The Checkout Page is the final step in the purchase process, choose a
          payment method, enter the transaction number, and attach the payment
          screenshot on our Telegram. This page ensures a secure, streamlined,
          and user-friendly experience to minimize cart abandonment and increase
          conversion rates.
        </p>
